...
var dao = require("crm/data/dao/Customers/AccountActivitiy");
...
rs.service()
	...
	.resource("{id}")
		.get(function(ctx) {
			...
			if (entity) {
				...
				http.sendResponseNotFound("AccountActivitiy not found");
			}
		})
		.catch(function(ctx, error) {
            if (error.name === "ForbiddenError") {
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/v4/js/crm/api/AccountActivitiy.js/" + entity.Id);
