...
var dao = require("crm/data/dao/Entities/OpportunityActivity");
	...
	.resource("{id}")
		.get(function(ctx) {
			...
			if (entity) {
				...
				http.sendResponseNotFound("OpportunityActivity not found");
			}
		})
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/v4/js/crm/api/OpportunityActivity.js/" + entity.Id);
