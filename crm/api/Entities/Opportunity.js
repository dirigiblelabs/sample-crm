...
var dao = require("crm/data/dao/Entities/Opportunity");
	...
	.resource("{id}")
		.get(function(ctx) {
			...
			if (entity) {
				...
				http.sendResponseNotFound("Opportunity not found");
			}
		})
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/v4/js/crm/api/Opportunity.js/" + entity.Id);
