...
.factory('$messageHub', [function(){
	...
	var message = function(evtName, data){
		messageHub.post({data: data}, 'crm.Configurations.Industry.' + evtName);
	};
	...
	return {
		...
		onEntityRefresh: function(callback) {
			on('crm.Configurations.Industry.refresh', callback);
		},
...
.controller('PageController', function ($scope, $http, $messageHub) {
	...
	var api = '../../../../../../../../services/v4/js/crm/api/Configurations/Industry.js';
