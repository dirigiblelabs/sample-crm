...
.factory('$messageHub', [function(){
	...
	var message = function(evtName, data){
		messageHub.post({data: data}, 'crm.Sales.Quote.' + evtName);
	};
	...
	return {
		...
		onEntityRefresh: function(callback) {
			on('crm.Sales.Quote.refresh', callback);
		},
		onAccountModified: function(callback) {
			on('crm.Sales.Account.modified', callback);
		},
		onProductModified: function(callback) {
			on('crm.Sales.Product.modified', callback);
		},
		onUoMModified: function(callback) {
			on('crm.Sales.UoM.modified', callback);
		},
		onCurrencyModified: function(callback) {
			on('crm.Sales.Currency.modified', callback);
		},
...
.controller('PageController', function ($scope, $http, $messageHub) {
	...
	var api = '../../../../../../../../services/v4/js/crm/api/Sales/Quote.js';
	var accountOptionsApi = '../../../../../../../../services/v4/js/crm/api/Customers/Account.js';
	var productOptionsApi = '../../../../../../../../services/v4/js/crm/api/Products/Product.js';
