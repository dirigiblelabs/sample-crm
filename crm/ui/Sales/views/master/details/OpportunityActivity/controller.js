...
.factory('$messageHub', [function(){
	...
	var message = function(evtName, data){
		messageHub.post({data: data}, 'crm.Sales.OpportunityActivity.' + evtName);
	};
	...
	return {
		...
		onEntityRefresh: function(callback) {
			on('crm.Sales.OpportunityActivity.refresh', callback);
		},
...
.controller('PageController', function ($scope, $http, $messageHub) {
	...
	var api = '../../../../../../../../../../services/v4/js/crm/api/Sales/OpportunityActivity.js';
