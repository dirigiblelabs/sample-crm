...
.factory('$messageHub', [function(){
	...
	var message = function(evtName, data){
		messageHub.post({data: data}, 'crm.Customers.Account.' + evtName);
	};
	...
	return {
		...
		onEntityRefresh: function(callback) {
			on('crm.Customers.Account.refresh', callback);
		},
		onIndustryModified: function(callback) {
			on('crm.Customers.Industry.modified', callback);
		},
...
.controller('PageController', function ($scope, $http, $messageHub) {
	...
	var api = '../../../../../../../../../../services/v4/js/crm/api/Customers/Account.js';
	var industryOptionsApi = '../../../../../../../../../../services/v4/js/crm/api/Configurations/Industry.js';
