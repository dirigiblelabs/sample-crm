...
.factory('$messageHub', [function(){
	...
	var message = function(evtName, data){
		messageHub.post({data: data}, 'crm.Entities.OpportunityActivity.' + evtName);
	};
...
.controller('PageController', function ($scope, $http, $messageHub) {
	...
	var api = '../../../../../../../../../../services/v4/js/crm/api/Entities/OpportunityActivity.js';
