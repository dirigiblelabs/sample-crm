...
.factory('$messageHub', [function(){
	...
	var message = function(evtName, data){
		messageHub.post({data: data}, 'crm.Entities.Opportunity.' + evtName);
	};
	...
	return {
		...
		onEntityRefresh: function(callback) {
			on('crm.Entities.Opportunity.refresh', callback);
		},
...
.controller('PageController', function ($scope, $http, $messageHub) {
	...
	var api = '../../../../../../../../../../services/v4/js/crm/api/Entities/Opportunity.js';
